...
export declare class ReportsService {
    ...
    private postedSalesWhere;
    private postedPurchasesWhere;
    ...
    customerStatement(customerId: string, query: Record<string, unknown>): Promise<{
        customer: {
            id: string;
            name: string;
    ...
    supplierStatement(supplierId: string, query: Record<string, unknown>): Promise<{
        supplier: {
            id: string;
            name: string;
            currentBalance: string;
