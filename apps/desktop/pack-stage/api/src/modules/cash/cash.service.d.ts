...
export declare class CashService {
    ...
    openSession(body: unknown, userId: string): Promise<{
        id: string;
        notes: string | null;
        status: import("@prisma/client").$Enums.CashSessionStatus;
        closedAt: Date | null;
    ...
    cashIn(body: unknown, userId: string): Promise<{
        id: string;
        createdAt: Date;
        createdById: string | null;
        amount: import("@prisma/client/runtime/library").Decimal;
    ...
    cashOut(body: unknown, userId: string): Promise<{
        id: string;
        createdAt: Date;
        createdById: string | null;
        amount: import("@prisma/client/runtime/library").Decimal;
    ...
    closeSession(body: unknown, userId: string): Promise<{
        id: string;
        notes: string | null;
        status: import("@prisma/client").$Enums.CashSessionStatus;
        closedAt: Date | null;
